...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsTbillPriceRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsTbillPriceRequest>, IWorkbookFunctionsTbillPriceRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsTbillPriceRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsTbillPriceRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsTbillPriceRequest(functionUrl, this.Client, options);
