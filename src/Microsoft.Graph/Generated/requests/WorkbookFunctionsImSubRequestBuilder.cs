...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsImSubRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsImSubRequest>, IWorkbookFunctionsImSubRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsImSubRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsImSubRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsImSubRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsImSubRequest(functionUrl, this.Client, options);
