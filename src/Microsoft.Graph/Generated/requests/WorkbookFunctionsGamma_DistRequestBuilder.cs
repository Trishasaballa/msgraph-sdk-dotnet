...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsGamma_DistRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsGamma_DistRequest>, IWorkbookFunctionsGamma_DistRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsGamma_DistRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsGamma_DistRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsGamma_DistRequest(functionUrl, this.Client, options);
