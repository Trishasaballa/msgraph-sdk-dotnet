...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsCoupDaysRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsCoupDaysRequest>, IWorkbookFunctionsCoupDaysRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsCoupDaysRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsCoupDaysRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsCoupDaysRequest(functionUrl, this.Client, options);
