...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsYieldRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsYieldRequest>, IWorkbookFunctionsYieldRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsYieldRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsYieldRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsYieldRequest(functionUrl, this.Client, options);
