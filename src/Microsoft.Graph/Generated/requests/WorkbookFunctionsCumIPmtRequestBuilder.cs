...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsCumIPmtRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsCumIPmtRequest>, IWorkbookFunctionsCumIPmtRequestBuilder
    {
        /// <summary>
        ...
        protected override IWorkbookFunctionsCumIPmtRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsCumIPmtRequest(functionUrl, this.Client, options);
