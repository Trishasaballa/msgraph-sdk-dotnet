...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsIrrRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsIrrRequest>, IWorkbookFunctionsIrrRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsIrrRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsIrrRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsIrrRequest(functionUrl, this.Client, options);
