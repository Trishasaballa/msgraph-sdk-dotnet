...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsDmaxRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsDmaxRequest>, IWorkbookFunctionsDmaxRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsDmaxRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsDmaxRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsDmaxRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsDmaxRequest(functionUrl, this.Client, options);
