...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsT_Dist_2TRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsT_Dist_2TRequest>, IWorkbookFunctionsT_Dist_2TRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsT_Dist_2TRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsT_Dist_2TRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsT_Dist_2TRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsT_Dist_2TRequest(functionUrl, this.Client, options);
