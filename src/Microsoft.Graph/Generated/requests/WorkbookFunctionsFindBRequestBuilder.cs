...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsFindBRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsFindBRequest>, IWorkbookFunctionsFindBRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsFindBRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsFindBRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsFindBRequest(functionUrl, this.Client, options);
