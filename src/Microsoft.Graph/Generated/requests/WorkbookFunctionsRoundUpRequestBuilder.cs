...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsRoundUpRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsRoundUpRequest>, IWorkbookFunctionsRoundUpRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsRoundUpRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsRoundUpRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsRoundUpRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsRoundUpRequest(functionUrl, this.Client, options);
