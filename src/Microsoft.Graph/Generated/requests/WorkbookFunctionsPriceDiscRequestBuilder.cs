...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsPriceDiscRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsPriceDiscRequest>, IWorkbookFunctionsPriceDiscRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsPriceDiscRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsPriceDiscRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsPriceDiscRequest(functionUrl, this.Client, options);
