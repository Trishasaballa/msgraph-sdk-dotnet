...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookNamedItemAddRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookNamedItemAddRequest>, IWorkbookNamedItemAddRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookNamedItemAddRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookNamedItemAddRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookNamedItemAddRequest(functionUrl, this.Client, options);
