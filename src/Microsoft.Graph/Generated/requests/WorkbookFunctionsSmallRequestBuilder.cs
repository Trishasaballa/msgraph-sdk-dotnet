...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsSmallRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsSmallRequest>, IWorkbookFunctionsSmallRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsSmallRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsSmallRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsSmallRequest(functionUrl, this.Client, options);
