...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsRightbRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsRightbRequest>, IWorkbookFunctionsRightbRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsRightbRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsRightbRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsRightbRequest(functionUrl, this.Client, options);
