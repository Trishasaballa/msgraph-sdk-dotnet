...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsNpvRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsNpvRequest>, IWorkbookFunctionsNpvRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsNpvRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsNpvRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsNpvRequest(functionUrl, this.Client, options);
