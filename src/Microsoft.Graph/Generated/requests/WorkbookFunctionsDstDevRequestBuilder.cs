...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsDstDevRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsDstDevRequest>, IWorkbookFunctionsDstDevRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsDstDevRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsDstDevRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsDstDevRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsDstDevRequest(functionUrl, this.Client, options);
