...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsPvRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsPvRequest>, IWorkbookFunctionsPvRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsPvRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsPvRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsPvRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsPvRequest(functionUrl, this.Client, options);
