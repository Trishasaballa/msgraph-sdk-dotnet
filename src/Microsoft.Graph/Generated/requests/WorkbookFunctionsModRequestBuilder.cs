...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsModRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsModRequest>, IWorkbookFunctionsModRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsModRequestBuilder"/>.
        /// </summary>
            ...
            : base(requestUrl, client)
        {
            ...
            this.SetParameter("divisor", divisor, true);
        }
        ...
        protected override IWorkbookFunctionsModRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsModRequest(functionUrl, this.Client, options);
