...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsUsdollarRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsUsdollarRequest>, IWorkbookFunctionsUsdollarRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsUsdollarRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsUsdollarRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsUsdollarRequest(functionUrl, this.Client, options);
