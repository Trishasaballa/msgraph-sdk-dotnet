...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsDaverageRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsDaverageRequest>, IWorkbookFunctionsDaverageRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsDaverageRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsDaverageRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsDaverageRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsDaverageRequest(functionUrl, this.Client, options);
