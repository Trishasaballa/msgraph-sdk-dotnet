...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsCoupNcdRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsCoupNcdRequest>, IWorkbookFunctionsCoupNcdRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsCoupNcdRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsCoupNcdRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsCoupNcdRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsCoupNcdRequest(functionUrl, this.Client, options);
