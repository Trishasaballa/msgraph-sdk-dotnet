...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsDsumRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsDsumRequest>, IWorkbookFunctionsDsumRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsDsumRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsDsumRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsDsumRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsDsumRequest(functionUrl, this.Client, options);
