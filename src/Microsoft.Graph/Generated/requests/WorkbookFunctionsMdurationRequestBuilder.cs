...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsMdurationRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsMdurationRequest>, IWorkbookFunctionsMdurationRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsMdurationRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsMdurationRequestBuilder(
            string requestUrl,
            IBaseClient client,
            System.Text.Json.JsonDocument settlement,
            System.Text.Json.JsonDocument maturity,
            System.Text.Json.JsonDocument coupon,
        ...
        protected override IWorkbookFunctionsMdurationRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsMdurationRequest(functionUrl, this.Client, options);
            ...
            if (this.HasParameter("coupon"))
            {
                request.RequestBody.Coupon = this.GetParameter<System.Text.Json.JsonDocument>("coupon");
            }
