...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsCoupDayBsRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsCoupDayBsRequest>, IWorkbookFunctionsCoupDayBsRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsCoupDayBsRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsCoupDayBsRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsCoupDayBsRequest(functionUrl, this.Client, options);
