...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsIntRateRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsIntRateRequest>, IWorkbookFunctionsIntRateRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsIntRateRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsIntRateRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsIntRateRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsIntRateRequest(functionUrl, this.Client, options);
