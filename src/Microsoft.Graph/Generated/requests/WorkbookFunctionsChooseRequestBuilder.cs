...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsChooseRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsChooseRequest>, IWorkbookFunctionsChooseRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsChooseRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsChooseRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsChooseRequest(functionUrl, this.Client, options);
