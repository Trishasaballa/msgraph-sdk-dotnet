...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsBesselKRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsBesselKRequest>, IWorkbookFunctionsBesselKRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsBesselKRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsBesselKRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsBesselKRequest(functionUrl, this.Client, options);
