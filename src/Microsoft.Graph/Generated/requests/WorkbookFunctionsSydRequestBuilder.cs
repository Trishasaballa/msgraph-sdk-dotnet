...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsSydRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsSydRequest>, IWorkbookFunctionsSydRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsSydRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsSydRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsSydRequest(functionUrl, this.Client, options);
