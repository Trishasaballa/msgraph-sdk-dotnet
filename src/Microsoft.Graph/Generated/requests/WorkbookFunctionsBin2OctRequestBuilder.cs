...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsBin2OctRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsBin2OctRequest>, IWorkbookFunctionsBin2OctRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsBin2OctRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsBin2OctRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsBin2OctRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsBin2OctRequest(functionUrl, this.Client, options);
