...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsDgetRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsDgetRequest>, IWorkbookFunctionsDgetRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsDgetRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsDgetRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsDgetRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsDgetRequest(functionUrl, this.Client, options);
