...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsRoundDownRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsRoundDownRequest>, IWorkbookFunctionsRoundDownRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsRoundDownRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsRoundDownRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsRoundDownRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsRoundDownRequest(functionUrl, this.Client, options);
