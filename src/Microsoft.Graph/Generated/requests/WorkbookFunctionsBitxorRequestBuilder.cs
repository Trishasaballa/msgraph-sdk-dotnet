...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsBitxorRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsBitxorRequest>, IWorkbookFunctionsBitxorRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsBitxorRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsBitxorRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsBitxorRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsBitxorRequest(functionUrl, this.Client, options);
