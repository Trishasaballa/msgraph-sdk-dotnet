...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsDecimalRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsDecimalRequest>, IWorkbookFunctionsDecimalRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsDecimalRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsDecimalRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsDecimalRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsDecimalRequest(functionUrl, this.Client, options);
