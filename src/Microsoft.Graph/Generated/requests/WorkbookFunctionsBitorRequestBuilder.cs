...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsBitorRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsBitorRequest>, IWorkbookFunctionsBitorRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsBitorRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsBitorRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsBitorRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsBitorRequest(functionUrl, this.Client, options);
