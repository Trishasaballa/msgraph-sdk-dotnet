...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsDvarPRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsDvarPRequest>, IWorkbookFunctionsDvarPRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsDvarPRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsDvarPRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsDvarPRequest(functionUrl, this.Client, options);
