...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsDec2OctRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsDec2OctRequest>, IWorkbookFunctionsDec2OctRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsDec2OctRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsDec2OctRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsDec2OctRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsDec2OctRequest(functionUrl, this.Client, options);
