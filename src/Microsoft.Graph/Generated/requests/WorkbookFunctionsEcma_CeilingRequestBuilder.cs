...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsEcma_CeilingRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsEcma_CeilingRequest>, IWorkbookFunctionsEcma_CeilingRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsEcma_CeilingRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsEcma_CeilingRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsEcma_CeilingRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsEcma_CeilingRequest(functionUrl, this.Client, options);
