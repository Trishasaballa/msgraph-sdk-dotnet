...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsF_InvRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsF_InvRequest>, IWorkbookFunctionsF_InvRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsF_InvRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsF_InvRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsF_InvRequest(functionUrl, this.Client, options);
