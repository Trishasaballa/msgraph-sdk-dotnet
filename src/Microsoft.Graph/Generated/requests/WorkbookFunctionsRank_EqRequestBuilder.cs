...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsRank_EqRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsRank_EqRequest>, IWorkbookFunctionsRank_EqRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsRank_EqRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsRank_EqRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsRank_EqRequest(functionUrl, this.Client, options);
