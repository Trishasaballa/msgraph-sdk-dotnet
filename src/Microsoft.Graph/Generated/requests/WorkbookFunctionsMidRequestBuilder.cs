...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsMidRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsMidRequest>, IWorkbookFunctionsMidRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsMidRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsMidRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsMidRequest(functionUrl, this.Client, options);
