...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsOddLPriceRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsOddLPriceRequest>, IWorkbookFunctionsOddLPriceRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsOddLPriceRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsOddLPriceRequestBuilder(
            string requestUrl,
            IBaseClient client,
            System.Text.Json.JsonDocument settlement,
            System.Text.Json.JsonDocument maturity,
            System.Text.Json.JsonDocument lastInterest,
        ...
        protected override IWorkbookFunctionsOddLPriceRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsOddLPriceRequest(functionUrl, this.Client, options);
            ...
            {
                request.RequestBody.LastInterest = this.GetParameter<System.Text.Json.JsonDocument>("lastInterest");
            }
