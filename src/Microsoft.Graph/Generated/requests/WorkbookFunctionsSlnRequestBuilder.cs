...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsSlnRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsSlnRequest>, IWorkbookFunctionsSlnRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsSlnRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsSlnRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsSlnRequest(functionUrl, this.Client, options);
