...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsSubtotalRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsSubtotalRequest>, IWorkbookFunctionsSubtotalRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsSubtotalRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsSubtotalRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsSubtotalRequest(functionUrl, this.Client, options);
