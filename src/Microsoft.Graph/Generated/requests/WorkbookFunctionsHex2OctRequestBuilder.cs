...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsHex2OctRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsHex2OctRequest>, IWorkbookFunctionsHex2OctRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsHex2OctRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsHex2OctRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsHex2OctRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsHex2OctRequest(functionUrl, this.Client, options);
