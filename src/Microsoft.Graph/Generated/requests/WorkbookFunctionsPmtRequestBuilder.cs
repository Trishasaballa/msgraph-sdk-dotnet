...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsPmtRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsPmtRequest>, IWorkbookFunctionsPmtRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsPmtRequestBuilder"/>.
        /// </summary>
        ...
        protected override IWorkbookFunctionsPmtRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsPmtRequest(functionUrl, this.Client, options);
