...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class WorkbookFunctionsDeltaRequestBuilder : BaseActionMethodRequestBuilder<IWorkbookFunctionsDeltaRequest>, IWorkbookFunctionsDeltaRequestBuilder
    {
        /// <summary>
        /// Constructs a new <see cref="WorkbookFunctionsDeltaRequestBuilder"/>.
        /// </summary>
        ...
        public WorkbookFunctionsDeltaRequestBuilder(
            string requestUrl,
            IBaseClient client,
        ...
        protected override IWorkbookFunctionsDeltaRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new WorkbookFunctionsDeltaRequest(functionUrl, this.Client, options);
